...
class Command {
    ...
    public function getAsArray() {
        return array($this->name, $this->description, $this->type, $this->type_id);
    }

    public function getAsAssocArray() {
        return array('id'=>$this->id, 'name'=>$this->name, 'description'=>$this->description, 'type'=>$this->type, 'type_id'=>$this->type_id);
    }
